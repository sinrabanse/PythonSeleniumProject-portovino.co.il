...
class Logger():
    file_name = f"/Users/sinrabanse/Pycharm/python_lessons/PythonSeleniumProject-portovino.co.il/logs/log_" + str(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")) + ".log"
